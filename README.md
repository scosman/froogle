...
### A fast ad-free search engine portal in 1 html file

[Froogle](https://froogle.fyi) is a search engine portal in 1 html file (plus optional proxy). Zero frameworks, zero dependencies. It uses the [Keenable](https://keenable.ai) search API.
